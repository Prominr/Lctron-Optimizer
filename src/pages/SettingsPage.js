      ...
      <div className="settings-layout">
        ...
        <aside className="settings-sidebar">
          ...
          <motion.div className="st-app-card" {...anim(0.07)}>
            ...
            <div className="st-app-row"><span className="st-app-row-label">Version</span><span className="st-app-row-val">v1.7.36</span></div>
        ...
        <div className="settings-main">
            ...
            <div className="st-card">
              <div className="st-update-body">
                ...
                <div className="st-update-info">
                  ...
                  <span className="st-update-sub">v1.7.36 installed</span>
          ...
          <motion.div className="st-section" {...anim(0.16)}>
            ...
            <div className="st-card">
              ...
              <div className="st-about-row"><span className="st-about-label">Version</span><span className="st-about-val">v1.7.36</span></div>
